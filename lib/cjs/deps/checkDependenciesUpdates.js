    ...
    function _execute(deps) {
        ...
        return (0, checkVersionValidity_1.default)(dependency.version, false).then((runnable) => {
            if ("NOT_RUNNABLE" === runnable) {
                ...
                results.push(Object.assign(Object.assign({}, dependency), { "time": (0, getFormatedTime_1.default)(), "result": "success", "message": dependency.version }));
            }
            return "RUNNABLE" === runnable;
        }).then((runCheck) => {
            return !runCheck ? Promise.resolve() : (0, checkAndFormateVersion_1.default)(dependency.version).then((formatedVersion) => {
                return (0, downloadPackageData_1.default)(dependency.name, options.npmrcFile).then((latest) => {

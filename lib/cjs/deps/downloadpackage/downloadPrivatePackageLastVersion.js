...
function downloadPrivatePackageLastVersion(packageName, npmrcFile) {
    const baseDir = (0, node_path_1.join)((0, node_os_1.homedir)(), "check-version-modules");
    const packageDir = (0, node_path_1.join)(baseDir, (Math.random() + 1).toString(36).substring(2));
    return (0, promises_1.mkdir)(packageDir, {
        ...
        return new Promise((resolve, reject) => {
            (0, node_child_process_1.execFile)("npm", ["install", packageName], {
                "cwd": packageDir,
                "windowsHide": true
            }, (err, stdout, stderr) => {
                if (err) {
